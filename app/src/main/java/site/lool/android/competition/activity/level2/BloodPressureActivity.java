...
public class BloodPressureActivity extends AppCompatActivity {
    ...
    int value0;
    EditText editText_bloodPressure_toolbar;
    ...
    private void initMember(){
        ...
        editText_bloodPressure_toolbar = (EditText)findViewById(R.id.editText_bloodPressure_toolbar);
    ...
    public void commit(View view){
        value0 = Integer.parseInt(editText_bloodPressure_toolbar.getText().toString()) ;
